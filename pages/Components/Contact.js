  ...
  return (
    ...
    <div id='Contact' className=' py-5 pb-16'>
      ...
      <div className=' py-3'>
              ...
              <textarea name="message" id="" cols="30" rows="6" autoComplete='off' placeholder='Write Something!' required className=' m-3 p-3  rounded-md bg-gradient-to-br from-teal-100 to-teal-300  placeholder:text-black' ></textarea>
              <div> <input type="submit" value='Send' className=' m-5 p-3 bg-gradient-to-r from-cyan-700 to-teal-700 text-white px-4 py-2 rounded-md ' /></div> 
            </form>
